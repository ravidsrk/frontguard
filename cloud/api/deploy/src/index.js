...
// src/report-html.ts
function generateReportHtml(run) {
  const resultsRows = (run.results || []).map(
    (r) => `
      <tr>
...
<body>
  <div class="container">
    <h1>\u{1F6E1}\uFE0F Frontguard Visual Report</h1>
    ...
    <div class="footer">
      Frontguard v0.1.0 \xB7 Visual regression testing for the modern web
    </div>
  </div>
...
app.get("/v1/usage", (c) => {
  ...
  return c.json({
    ...
    limits: { runs: 500, screenshots: 5e3 }
  });
});
