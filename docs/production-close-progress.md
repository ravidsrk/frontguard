...
| (A-misc) Slack SSRF | int-7 (PARTIAL) | C8-residual | OPEN | `int7-slack-ssrf` |
...
| action-doc-residual | A/B | C8 | hot | [docs-5] | ✗ | ✗ | ✗ | ✗ | ✗ | v0 tag + marketplace (human) | — | — | — | P1; int-3 CODE_CLOSED; docs-6 OPS; serialize w/ C3. `task_65cfef634489` |
| int7-slack-ssrf | A | C8-res | indep | [int-7] | ✗ | ✗ | ✗ | ✗ | ✗ | none | — | — | — | P1; unclustered residual. `task_0ffae0841984` |
