...
| A10 Process hygiene | fix-progress drift, SECURITY.md versions, launch-readiness banner, npm version staleness | — | OPEN (doc-reconcile subtask CLOSED via PR#106; remains OPEN until A10REL + T_FINAL merge) | `a10-doc-reconcile`, `a10-release-prep`, `T_FINAL` |
