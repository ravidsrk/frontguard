...
To accept current screenshots as new baselines, use the dedicated [`frontguard update-baselines`](#frontguard-update-baselines) command rather than a flag on `run`.
