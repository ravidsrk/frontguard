...
<Callout type="warn">
  ...
  [`integrations/slack-app/manifest.yml`](https://github.com/ravidsrk/frontguard/blob/main/integrations/slack-app/manifest.yml)
  — see [Self-hosting the Slack app](#self-hosting-the-slack-app) below.
</Callout>
