...
<https://frontguard.dev/integrations/slack>. Slack will:
...
5. Create the Slack app at <https://api.slack.com/apps> → "From an app
...
<https://github.com/ravidsrk/frontguard/issues> with the use case.
