...
The hosted app is published to the GitHub Marketplace:
  ...
  → [github.com/marketplace/frontguard](https://github.com/marketplace/frontguard)
...
[github.com/ravidsrk/frontguard/blob/main/integrations/github-app/manifest.yml](https://github.com/ravidsrk/frontguard/blob/main/integrations/github-app/manifest.yml).
