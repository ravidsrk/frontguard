...
Once the listing is live, installing is one-click from the GitHub Marketplace:
pick the account (personal or organisation), then choose the repositories to
grant access to. You can pick **All repositories** or **Select repositories**
— switching later is supported via the GitHub UI.
...
- The workflow pins to **`ravidsrk/frontguard@v0`**, not `@main`. New repos
