...
### AI analysis
Chromatic has no AI explanation feature. Frontguard sends baseline + current images to OpenAI/Anthropic (BYOK) and returns a classification, severity, explanation, and optional suggested fix. See [AI Analysis](/docs/guides/ai-analysis).
