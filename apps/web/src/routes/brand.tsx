    ...
    <div style={s('background: #0d0c0b; color: #b8b0a6; min-height: 100vh;')}>
      ...
      <div style={s('padding: 56px 28px 80px;')}>
        <div style={s('max-width: 1080px; margin: 0 auto;')}>
          <h1
            style={s(
              'font-size: 52px; letter-spacing: -0.04em; font-weight: 700; color: #f5f1ea; margin: 0 0 16px; line-height: 1.0;',
            )}
          >
            The Frontguard
            <br />
          ...
          <p
            style={s(
              'font-size: 17px; color: #b8b0a6; margin: 0 0 64px; max-width: 540px; line-height: 1.55;',
            )}
          >
          ...
          <h2
            style={s(
              `font-family: ${MONO}; font-size: 12px; color: #e8862e; letter-spacing: 0.08em; margin-bottom: 20px;`,
            )}
          >
            01 / THE MARK
          </h2>
          ...
          >
            <div
              style={s(
                'border: 1px solid #2a2622; background: #131210; padding: 48px; display: flex; align-items: center; justify-content: center; min-height: 280px;',
              )}
            >
              <Shield w={120} h={142} notch="#131210" line={7} />
            </div>
            <div
              style={s(
                'border: 1px solid #2a2622; background: #131210; padding: 32px; display: flex; flex-direction: column; justify-content: center; gap: 20px;',
              )}
            >
              <div>
                <div style={s(`font-family: ${MONO}; font-size: 12px; color: #f5f1ea; margin-bottom: 6px;`)}>
                  The shield
                </div>
                <p style={s('font-size: 13.5px; line-height: 1.55; color: #8c847a; margin: 0;')}>
              ...
              <div>
                ...
                <p style={s('font-size: 13.5px; line-height: 1.55; color: #8c847a; margin: 0;')}>
                  ...
                  <span style={s('color: #e8862e;')}>baseline</span> vs{' '}
                  <span style={s('color: #e8862e;')}>current</span>. The visual diff, built into
                  the mark.
                </p>
              </div>
              <div>
                ...
                <p style={s('font-size: 13.5px; line-height: 1.55; color: #8c847a; margin: 0;')}>
                  ...
                  <span
                    style={s(
                      'display: inline-block; width: 7px; height: 13px; background: #e8862e; vertical-align: -1px; animation: fg-blink 1.1s step-end infinite;',
                    )}
                  />{' '}
                  — the terminal, always.
                </p>
          ...
          >
            <div
              style={s(
                'border: 1px solid #2a2622; background: #131210; padding: 36px 28px; display: flex; flex-direction: column; align-items: center; gap: 22px;',
              )}
            >
              <div style={s('display: flex; align-items: center; gap: 13px;')}>
                ...
                <span
                  style={s(
                    `font-family: ${MONO}; font-weight: 700; font-size: 21px; letter-spacing: -0.02em; color: #f5f1ea;`,
                  )}
                >
                  frontguard
                  <span
                    style={s(
                      'display: inline-block; width: 8px; height: 16px; background: #e8862e; vertical-align: -1px; margin-left: 2px;',
                    )}
                  />
                </span>
              </div>
              <span style={s(`font-family: ${MONO}; font-size: 11px; color: #564f48;`)}>
                PRIMARY LOCKUP
              </span>
            </div>
            <div
              style={s(
                'border: 1px solid #2a2622; background: #f5f1ea; padding: 36px 28px; display: flex; flex-direction: column; align-items: center; gap: 22px;',
              )}
            >
              <div style={s('display: flex; align-items: center; gap: 13px;')}>
                ...
                <span
                  style={s(
                    `font-family: ${MONO}; font-weight: 700; font-size: 21px; letter-spacing: -0.02em; color: #14110d;`,
                  )}
                >
                  frontguard
                </span>
              </div>
              <span style={s(`font-family: ${MONO}; font-size: 11px; color: #9b958c;`)}>
                MONO · ON LIGHT
              </span>
            </div>
            <div
          ...
          <div
            style={s(
              `font-family: ${MONO}; font-size: 11px; color: #564f48; letter-spacing: 0.06em; margin-bottom: 12px;`,
            )}
          >
          ...
          >
            {neutrals.map((c) => (
              <div key={c.name} className="fg-swatch" data-testid="neutral-swatch">
                <div
                  data-testid="swatch-fill"
                  style={s(`height: 84px; background: ${c.hex}; border: 1px solid #2a2622;`)}
                />
                <div style={s(`font-family: ${MONO}; font-size: 11px; color: #d8d0c5; margin-top: 8px;`)}>
                  {c.name}
                </div>
          ...
          <div style={s('display: grid; grid-template-columns: 1fr 1.4fr; gap: 32px; margin-bottom: 64px;')}>
            <div>
              ...
              <div
                ...
                style={s(
                  'background: #e8862e; padding: 24px; min-height: 160px; display: flex; flex-direction: column; justify-content: space-between;',
                )}
              >
                <span style={s(`font-family: ${MONO}; font-size: 13px; color: #4a2a0e; font-weight: 700;`)}>
                  Frontguard Amber
                </span>
                <div style={s(`font-family: ${MONO}; font-size: 12px; color: #4a2a0e; line-height: 1.7;`)}>
                  #E8862E
                  <br />
                  oklch(0.72 0.18 50)
                </div>
              ...
              <div style={s('display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px;')}>
                {statuses.map((st) => (
                  <div
                    ...
                    style={s(
                      'border: 1px solid #2a2622; background: #131210; padding: 16px 18px; display: flex; align-items: center; gap: 14px;',
                    )}
                  >
                    <span
                      style={s(
                        `font-family: ${MONO}; font-size: 22px; color: ${st.hex}; width: 22px; text-align: center;`,
                      )}
                    >
                      {st.glyph}
                    </span>
                    <div>
                      <div style={s(`font-family: ${MONO}; font-size: 13px; color: #f5f1ea;`)}>
                        {st.label}
                      </div>
                      <div style={s(`font-family: ${MONO}; font-size: 10.5px; color: #6b645c;`)}>
                        {st.hex}
                      </div>
                    </div>
                  </div>
          ...
          <div style={s('display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 24px;')}>
            <div style={s('border: 1px solid #2a2622; background: #131210; padding: 32px;')}>
              ...
              >
                ...
                <span style={s(`font-family: ${MONO}; font-size: 11px; color: #e8862e;`)}>
                  Space Grotesk
                </span>
              </div>
              <div
                style={s(
                  "font-family: 'Space Grotesk', sans-serif; font-weight: 700; font-size: 46px; color: #f5f1ea; letter-spacing: -0.03em; line-height: 1; margin-bottom: 4px;",
                )}
              >
                Aa
              </div>
              <div
                style={s(
                  "font-family: 'Space Grotesk', sans-serif; font-size: 15px; color: #8c847a; letter-spacing: 0.04em; margin-bottom: 18px;",
                )}
              >
            ...
            <div style={s('border: 1px solid #2a2622; background: #131210; padding: 32px;')}>
              ...
              <div
                style={s(
                  `font-family: ${MONO}; font-weight: 700; font-size: 46px; color: #f5f1ea; line-height: 1; margin-bottom: 4px;`,
                )}
              >
                Aa
              </div>
              <div style={s(`font-family: ${MONO}; font-size: 14px; color: #8c847a; margin-bottom: 18px;`)}>
                ABCDEFGHIJKLM abcdefghijklm 0123456789
              </div>
            </div>
          </div>
          <div
            style={s(
              'border: 1px solid #2a2622; background: #131210; padding: 32px 36px; margin-bottom: 64px;',
            )}
            data-testid="type-scale"
          >
            <div
              style={s(
                'display: flex; align-items: baseline; gap: 20px; padding: 12px 0; border-bottom: 1px solid #211e1b;',
              )}
            >
              <span style={s(`font-family: ${MONO}; font-size: 11px; color: #564f48; width: 96px;`)}>
                DISPLAY / 52
              </span>
              <span
                style={s(
                  "font-family: 'Space Grotesk', sans-serif; font-weight: 700; font-size: 38px; color: #f5f1ea; letter-spacing: -0.035em;",
                )}
              >
            ...
            >
              ...
              <span
                style={s(
                  "font-family: 'Space Grotesk', sans-serif; font-weight: 600; font-size: 27px; color: #f5f1ea; letter-spacing: -0.02em;",
                )}
              >
            ...
            >
              ...
              <span
                style={s(
                  "font-family: 'Space Grotesk', sans-serif; font-size: 16px; color: #b8b0a6;",
                )}
              >
                Renders every page and explains what changed and why.
              </span>
            </div>
            <div style={s('display: flex; align-items: baseline; gap: 20px; padding: 12px 0;')}>
              ...
              <span style={s(`font-family: ${MONO}; font-size: 13px; color: #e8862e;`)}>
                $ npx -p @frontguard/cli frontguard run --url localhost:3000
              </span>
            </div>
          </div>
          ...
          <div style={s('display: grid; grid-template-columns: repeat(3, 1fr); gap: 20px;')}>
            {voice.map((v) => (
              <div
                key={v.label}
                style={s('border: 1px solid #2a2622; background: #131210; padding: 26px 24px;')}
              >
                <div style={s(`font-family: ${MONO}; font-size: 12px; color: ${v.color}; margin-bottom: 10px;`)}>
                  {v.label}
                </div>
          ...
          <h2
            style={s(
              `font-family: ${MONO}; font-size: 12px; color: #e8862e; letter-spacing: 0.08em; margin: 64px 0 20px;`,
            )}
          >
            05 / MESSAGING
          </h2>
          <div
            style={s(
              'border: 1px solid #2a2622; background: #131210; padding: 36px 34px; margin-bottom: 20px;',
            )}
          >
            <div
              style={s(
            ...
            <div
              style={s(
                'font-size: 34px; letter-spacing: -0.03em; font-weight: 700; color: #f5f1ea; line-height: 1.1;',
              )}
            >
          ...
          <div style={s('display: grid; grid-template-columns: 1fr 1fr; gap: 20px;')}>
              ...
              <ul style={s('list-style: none; padding: 0; margin: 0; display: grid; gap: 11px;')}>
                {say.map((x) => (
                  <li
                    key={x}
                    style={s(
                      'display: grid; grid-template-columns: 16px 1fr; gap: 10px; font-size: 14px; line-height: 1.5; color: #c8c0b6;',
                    )}
                  >
            ...
            <div style={s('border: 1px solid #3a1f1f; background: #170f0e; padding: 26px 24px;')}>
              <div style={s(`font-family: ${MONO}; font-size: 12px; color: #e5484d; margin-bottom: 16px;`)}>
                DON'T
              </div>
              <ul style={s('list-style: none; padding: 0; margin: 0; display: grid; gap: 11px;')}>
                {dont.map((x) => (
                  <li
                    key={x}
                    style={s(
                      'display: grid; grid-template-columns: 16px 1fr; gap: 10px; font-size: 14px; line-height: 1.5; color: #b8b0a6;',
                    )}
                  >
                    <span style={s(`color: #e5484d; font-family: ${MONO};`)}>−</span>
                    {x}
                  </li>
                ))}
              </ul>
