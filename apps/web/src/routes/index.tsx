...
const stages = [
  {
    num: "01",
    title: "Discover",
    desc: "Crawl, filesystem scan, or config — finds every route automatically.",
  },
  {
    num: "02",
    title: "Filter",
    desc: "Dependency graph renders only pages affected by your changes.",
  },
  {
    num: "03",
    title: "Render",
...
const features = [
  {
    tag: "DISCOVERY",
    title: "Zero-config routes",
    desc: "Auto-crawls your app to find every page. No manual route lists.",
  },
  {
    tag: "RENDER",
    title: "Multi-browser",
    desc: "Chromium, Firefox and WebKit via Playwright from day one.",
  },
  {
    tag: "SPEED",
    title: "Smart rendering",
    desc: "Dependency graph renders only the pages your PR actually affects.",
  },
  {
    tag: "STORAGE",
    title: "Git-native baselines",
    desc: "Stored in an orphan branch — zero bloat on your main branch.",
  },
  {
    tag: "PREVIEW",
    title: "Preview deploys",
    desc: "Auto-detects Vercel and Netlify preview URLs. Push and go.",
  },
  {
    tag: "CONFIG",
    title: "Per-route thresholds",
    desc: "Strict on /checkout, relaxed on /blog — all in one file.",
  },
  {
    tag: "DETECT",
    title: "Framework detection",
    desc: "Next.js, Remix, SvelteKit, Nuxt and Astro out of the box.",
  },
  {
    tag: "SECURITY",
    title: "Security hardened",
    desc: "Shell-injection prevention, path-traversal guards, key redaction.",
  },
  {
    tag: "REPORT",
    title: "PR thumbnails",
...
const plugins = [
  ...
  {
    name: "Perf Budgets",
    desc: "LCP / CLS / TTFB thresholds tied to the diff.",
  },
  {
    name: "Accessibility",
    desc: "axe-core WCAG audits in the same render pass.",
  },
  {
    name: "3rd-Party Scripts",
    desc: "Flags ad / analytics / widget drift between runs.",
  },
...
const INSTALL_TABS: InstallTab[] = [
  ...
  },
  {
    ...
    render: (
      <>
        <span style={s("color: #7c746b;")}>$ </span>npm install -D
        @frontguard/cli @frontguard/playwright
      </>
    ),
  },
  {
  ...
  return (
    <div id="install" style={s("margin-top: 20px; scroll-margin-top: 80px;")}>
      <div
        ...
        onKeyDown={onKeyDown}
        style={s(
          "display: flex; flex-wrap: wrap; gap: 4px; border-bottom: 1px solid #211e1b;",
        )}
      >
      ...
      >
        ...
        >
          <div
            style={s(
              "display: flex; align-items: center; justify-content: space-between; padding: 11px 16px; border-bottom: 1px solid #211e1b; background: #161412;",
            )}
          >
            <span
              style={s(
                `font-family: ${MONO}; font-size: 12px; color: #564f48;`,
              )}
            >
              {tab.filename}
            </span>
            <button
              ...
              style={s(
                `font-family: ${MONO}; font-size: 12px; color: #b8b0a6; background: #1f1c19; border: 1px solid #322d28; padding: 6px 14px; cursor: pointer;`,
              )}
            >
              {copyLabel}
            </button>
          ...
          <pre
            style={s(
              `margin: 0; padding: 20px 22px; font-family: ${MONO}; font-size: 12.5px; line-height: 1.7; color: #b8b0a6; overflow-x: auto; white-space: pre-wrap;`,
            )}
          >
            {tab.render}
          </pre>
...
function ValidationSection() {
  ...
  const stats = [
    {
      value: `${aggregate.reposBooted} / ${aggregate.reposAttempted}`,
      label: "repositories booted end-to-end this run",
    },
    {
      value: String(aggregate.recheckRouteCount),
      label: "routes re-rendered and re-checked",
    },
    {
      value: String(aggregate.recheckPositiveCount),
      label: "false positives flagged on unchanged pages",
    },
    {
      value: formatPercent(aggregate.pixelFalsePositiveRate),
      label: "pixel-diff false-positive rate",
    },
  ];
  ...
  return (
    <section
      id="validation"
      style={s(
        "max-width: 1200px; margin: 0 auto; padding: 20px 28px 84px; scroll-margin-top: 80px;",
      )}
    >
      <p
        style={s(
      ...
      <h2
        style={s(
          "font-size: 38px; letter-spacing: -0.03em; font-weight: 700; color: #f5f1ea; margin: 0 0 18px;",
        )}
      >
      ...
      <p
        style={s(
          "font-size: 16px; color: #b8b0a6; margin: 0 0 44px; max-width: 640px; line-height: 1.55;",
        )}
      >
        We run Frontguard against live open-source apps and publish what the
        harness measured — including the repos it couldn't boot. No accuracy
        figure ships until the AI classification pass clears the gate.
      </p>
      <div
        style={s(
          "display: grid; grid-template-columns: repeat(2, 1fr); gap: 1px; background: #211e1b; border: 1px solid #211e1b; margin-bottom: 32px;",
        )}
      >
        {stats.map((st) => (
          <div
            key={st.label}
            style={s("background: #0d0c0b; padding: 22px 20px;")}
          >
            <div
              style={s(
                `font-family: ${MONO}; font-size: 30px; font-weight: 700; color: #f5f1ea;`,
              )}
            >
              {st.value}
            </div>
            <div style={s("font-size: 13px; color: #7c746b; margin-top: 6px;")}>
              {st.label}
            </div>
          </div>
        ))}
        ...
        >
            ...
            <tr style={s("background: #161412;")}>
              {[
                ...
                <th
                  ...
                  scope="col"
                  style={s(
                    `padding: 14px 16px; font-family: ${MONO}; font-size: 11px; color: #7c746b; font-weight: 500; letter-spacing: 0.04em; text-transform: uppercase; ${h !== "Repository" && h !== "Category" ? "text-align: center;" : ""}`,
                  )}
                >
                  {h}
                </th>
          ...
          <tbody>
            {booted.map((r) => (
              <tr key={r.name} style={s("border-top: 1px solid #211e1b;")}>
                <th
                  scope="row"
                  style={s(
                    "padding: 14px 16px; font-weight: 400; color: #f5f1ea;",
                  )}
                >
                  {r.name}
                </th>
                <td style={s("padding: 14px 16px; color: #8c847a;")}>
                  {r.category}
                </td>
                <td
                  style={s(
                    `padding: 14px 16px; text-align: center; font-family: ${MONO}; color: #4fb477;`,
                  )}
                >
                  {r.recheckPass}
                </td>
                <td
                  style={s(
                    `padding: 14px 16px; text-align: center; font-family: ${MONO}; color: #f5f1ea;`,
                  )}
                >
            ...
            {skipped.map((r) => (
              <tr
                key={r.name}
                data-testid="skipped-repo"
                style={s("border-top: 1px solid #211e1b;")}
              >
                <th
                  scope="row"
                  style={s(
                ...
                <td
                  colSpan={3}
                  style={s(
                    "padding: 14px 16px; font-size: 12.5px; color: #8c847a;",
                  )}
                >
                  <span style={s(`font-family: ${MONO}; color: #e8862e;`)}>
                    skipped
                  </span>{" "}
                  — {r.skipReason}
                </td>
      ...
      <p
        style={s(
          "margin: 24px 0 0; max-width: 760px; font-size: 14px; line-height: 1.6; color: #b8b0a6;",
        )}
      >
        ...
        {aiEnabled
          ? null
          : "AI classification was disabled in this run, so no accuracy or AI false-positive number is published yet. "}
        We gate the launch on accuracy ≥{" "}
        {Math.round(VALIDATION_GATE.minAccuracy * 100)}% and a false-positive
        rate below {Math.round(VALIDATION_GATE.maxFalsePositiveRate * 100)}%.
        Read the{" "}
        <a
          href={VALIDATION_RESULTS_URL}
          target="_blank"
          rel="noopener noreferrer"
          style={s("color: #e8862e;")}
        >
          full results
        </a>{" "}
        or the{" "}
...
function Home() {
  ...
  return (
    <div
      style={s(
        "background: #0d0c0b; color: #b8b0a6; min-height: 100vh; overflow-x: hidden;",
      )}
    >
      <Nav />
      ...
      <header
        id="top"
        style={s(
          "position: relative; max-width: 1200px; margin: 0 auto; padding: 88px 28px 72px;",
        )}
      >
        <div
          style={s(
        ...
        >
          <div>
            <div
              style={s(
                "display: inline-flex; align-items: center; gap: 10px; font-family: 'JetBrains Mono', monospace; font-size: 12px; color: #e8862e; border: 1px solid #3a2a18; background: #1a130b; padding: 6px 12px; margin-bottom: 26px; white-space: nowrap;",
              )}
            >
              <span
                style={s(
            ...
            <h1
              style={s(
                "font-size: 58px; line-height: 1.02; letter-spacing: -0.035em; font-weight: 700; color: #f5f1ea; margin: 0 0 22px;",
              )}
            >
            ...
            <div
              style={s(
                "display: flex; align-items: stretch; max-width: 440px; margin-bottom: 22px; border: 1px solid #322d28; background: #161412;",
              )}
            >
              <span
                style={s(
                  "font-family: 'JetBrains Mono', monospace; font-size: 14px; color: #e6e0d6; padding: 14px 16px; flex: 1; white-space: nowrap; overflow: hidden;",
                )}
              >
                <span style={s("color: #7c746b;")}>$ </span>npm install
                @frontguard/cli
              </span>
              <button
                onClick={() => copyInstall("npm install @frontguard/cli")}
                className="fg-btn-ghost"
                style={s(
                  "font-family: 'JetBrains Mono', monospace; font-size: 12px; color: #b8b0a6; background: #1f1c19; border: none; border-left: 1px solid #322d28; padding: 0 18px; cursor: pointer;",
                )}
              >
                {installLabel}
              </button>
            ...
            <div style={s("display: flex; gap: 14px;")}>
              <Link
                ...
                style={s(
                  "background: #e8862e; color: #0d0c0b; font-family: 'JetBrains Mono', monospace; font-weight: 700; font-size: 14px; padding: 14px 26px; text-decoration: none;",
                )}
              >
                Get started →
              </Link>
              <a
                ...
                className="fg-btn-ghost"
                style={s(
                  "border: 1px solid #322d28; color: #f5f1ea; font-family: 'JetBrains Mono', monospace; font-weight: 500; font-size: 14px; padding: 14px 26px; text-decoration: none;",
                )}
              >
                ★ Star
              </a>
          ...
          <div style={s("position: relative;")}>
            <div
              style={s(
                "position: absolute; inset: -40px -20px -40px 20px; background: radial-gradient(60% 50% at 60% 40%, rgba(232,134,46,0.10), transparent 70%); pointer-events: none;",
              )}
            />
            <div
              style={s(
                "position: relative; background: #121110; border: 1px solid #2a2622; box-shadow: 0 24px 60px rgba(0,0,0,0.5); overflow: hidden;",
              )}
            >
              <div
                style={s(
                  "display: flex; align-items: center; gap: 8px; padding: 12px 16px; border-bottom: 1px solid #211e1b; background: #161412;",
                )}
              >
                <span
                  style={s(
                    "width: 11px; height: 11px; border-radius: 50%; background: #322d28;",
                  )}
                />
                <span
                  style={s(
                ...
                <span
                  style={s(
                    "margin-left: 10px; font-family: 'JetBrains Mono', monospace; font-size: 12px; color: #564f48;",
                  )}
                >
                  frontguard run
                </span>
              ...
              <div
                style={s(
                  "font-family: 'JetBrains Mono', monospace; font-size: 12.5px; line-height: 1.85; padding: 18px 20px; color: #b8b0a6; white-space: pre;",
                )}
            ...
            <div
              style={s(
                "position: relative; margin: -22px 0 0 auto; width: 86%; background: #1a130b; border: 1px solid #3a2a18; padding: 16px 18px; box-shadow: 0 16px 40px rgba(0,0,0,0.45);",
              )}
            >
              <div
                style={s(
                  "display: flex; align-items: center; gap: 8px; font-family: 'JetBrains Mono', monospace; font-size: 11px; color: #e5484d; margin-bottom: 8px; letter-spacing: 0.04em;",
                )}
              >
                <span
                  style={s(
      ...
      <section
        style={s(
          "border-top: 1px solid #211e1b; border-bottom: 1px solid #211e1b; background: #100f0e;",
        )}
      >
        <div
          style={s(
        ...
        >
          <div>
            <p
              style={s(
                `font-family: ${MONO}; font-size: 12px; color: #7c746b; letter-spacing: 0.08em; margin: 0 0 16px;`,
              )}
            >
          ...
          <div
            style={s(
              "display: grid; grid-template-columns: repeat(2, 1fr); gap: 1px; background: #211e1b; border: 1px solid #211e1b;",
            )}
          >
            {stats.map((st) => (
              <div
              ...
              >
                <div
                  style={s(
                    `font-family: ${MONO}; font-size: 30px; font-weight: 700; color: ${st.c};`,
                  )}
                >
                  {st.v}
                </div>
                <div
                  style={s("font-size: 13px; color: #7c746b; margin-top: 6px;")}
                >
                  {st.d}
                </div>
              </div>
      ...
      {/* ============ THREE PILLARS ============ */}
      <section
        style={s("max-width: 1200px; margin: 0 auto; padding: 84px 28px 20px;")}
      >
        <p style={eyebrow}>// HOW FRONTGUARD THINKS</p>
        <h2
          style={s(
            "font-size: 38px; letter-spacing: -0.03em; font-weight: 700; color: #f5f1ea; margin: 0 0 48px; max-width: 620px;",
          )}
        >
        ...
        >
          {pillars.map((p) => (
            <div
              key={p.n}
              className="fg-card-hover"
              style={s(
                "border: 1px solid #2a2622; background: #131210; padding: 28px 24px;",
              )}
            >
              <div
                style={s(
                  `font-family: ${MONO}; font-size: 12px; color: ${p.c}; margin-bottom: 18px;`,
                )}
              >
                {p.n}
              </div>
              <h3
                style={s(
                  "font-size: 21px; color: #f5f1ea; margin: 0 0 10px; font-weight: 600; letter-spacing: -0.01em;",
                )}
              >
                {p.h}
              </h3>
              <p
                style={s(
                  "font-size: 14.5px; line-height: 1.6; color: #b8b0a6; margin: 0;",
                )}
              >
                {p.p}
              </p>
      ...
      {/* ============ TWO WAYS IN ============ */}
      <section
        style={s("max-width: 1200px; margin: 0 auto; padding: 84px 28px 0;")}
      >
        ...
        <p
          style={s(
            "font-size: 16px; color: #b8b0a6; margin: 0 0 44px; max-width: 600px;",
          )}
        >
          Run it standalone against any URL, or drop visual assertions straight
          into the Playwright suite you already have. No proprietary snapshot
        ...
        >
          <div
            className="fg-card-hover"
            style={s(
              "border: 1px solid #2a2622; background: #131210; overflow: hidden;",
            )}
          >
            <div
              style={s(
                "display: flex; align-items: center; justify-content: space-between; padding: 14px 20px; border-bottom: 1px solid #211e1b;",
              )}
            >
              <span
                style={s(
                  `font-family: ${MONO}; font-size: 13px; color: #f5f1ea; font-weight: 500;`,
                )}
              >
                Standalone CLI
              </span>
              <span
                style={s(
                  `font-family: ${MONO}; font-size: 11px; color: #564f48;`,
                )}
              >
                @frontguard/cli
              </span>
            ...
            <pre
              style={s(
                `margin: 0; padding: 20px; font-family: ${MONO}; font-size: 13px; line-height: 1.8; color: #d8d0c5; overflow-x: auto;`,
              )}
              dangerouslySetInnerHTML={{ __html: CLI_HTML }}
            />
            <p
              style={s(
                "margin: 0; padding: 0 20px 20px; font-size: 13.5px; line-height: 1.55; color: #8c847a;",
              )}
            >
              Point it at any URL. It auto-discovers routes, renders, diffs, and
              posts the verdict — zero test files to write.
            </p>
          </div>
          <div
            className="fg-card-hover"
          ...
          >
            ...
            <pre
              style={s(
                `margin: 0; padding: 20px; font-family: ${MONO}; font-size: 13px; line-height: 1.8; color: #b8b0a6; overflow-x: auto;`,
              )}
              dangerouslySetInnerHTML={{ __html: PW_HTML }}
            />
            <p
              style={s(
                "margin: 0; padding: 0 20px 20px; font-size: 13.5px; line-height: 1.55; color: #8c847a;",
            ...
            >
              Three lines in a test you already wrote. Reuses the page
              Playwright just rendered — no second browser launch.
            </p>
          </div>
        </div>
        <InstallTabs />
      ...
      >
        ...
        <div
          style={s(
            "display: grid; grid-template-columns: repeat(6, 1fr); gap: 0; border: 1px solid #2a2622;",
          )}
        >
          {stages.map((st) => (
            <div
              key={st.num}
              style={s(
                "padding: 22px 18px; border-right: 1px solid #2a2622; background: #131210; position: relative;",
              )}
            >
              <div
                style={s(
                  `font-family: ${MONO}; font-size: 11px; color: #564f48; margin-bottom: 14px;`,
                )}
              >
                {st.num}
              </div>
              <div
                style={s(
                  `font-family: ${MONO}; font-size: 13px; color: #e8862e; margin-bottom: 8px; font-weight: 500;`,
                )}
              >
                {st.title}
              </div>
              <div
                style={s(
                  "font-size: 12.5px; line-height: 1.5; color: #8c847a;",
                )}
              >
                {st.desc}
              </div>
        ...
        >
          ...
          >
              ...
              >
                {[
                  ...
                  <li
                    key={li}
                    style={s(
                      "display: flex; gap: 12px; font-size: 14.5px; color: #d8d0c5;",
                    )}
                  >
                    <span style={s(`color: #4fb477; font-family: ${MONO};`)}>
                      ✓
                    </span>
                    {li}
                  </li>
            ...
            <div style={s("display: grid; gap: 16px;")}>
              <div
                style={s(
                  "border: 1px solid #3a1f1f; background: #170f0e; padding: 20px 22px;",
                )}
              >
                <div
                  style={s(
                ...
                >
                  <span
                    style={s(
                      `font-family: ${MONO}; font-size: 13px; color: #f5f1ea;`,
                    )}
                  >
                    ✘ /dashboard{" "}
                    <span style={s("color: #7c746b;")}>@ 375px</span>
                  </span>
                  <span
                    style={s(
                      `font-family: ${MONO}; font-size: 11px; color: #e5484d; border: 1px solid #4a2424; padding: 3px 9px;`,
                    )}
                  >
                    REGRESSION · 94%
                  </span>
              ...
              <div
                style={s(
                  "border: 1px solid #1f3a28; background: #0e1410; padding: 20px 22px;",
                )}
              >
                <div
                  style={s(
                ...
                >
                  ...
                  >
                    ✓ /pricing{" "}
                    <span style={s("color: #7c746b;")}>@ 1440px</span>
                  </span>
                  <span
                    style={s(
                      `font-family: ${MONO}; font-size: 11px; color: #4fb477; border: 1px solid #24472f; padding: 3px 9px;`,
                    )}
                  >
                    INTENTIONAL · 91%
                  </span>
                ...
                >
                  "New 'Enterprise' pricing tier added. Layout intact, content
                  expanded. Not a regression."
                </p>
              </div>
            </div>
          </div>
      ...
      >
        ...
        <h2
          style={s(
            "font-size: 38px; letter-spacing: -0.03em; font-weight: 700; color: #f5f1ea; margin: 0 0 48px;",
          )}
        >
        ...
        >
          {features.map((f) => (
            <div
              key={f.title}
              className="fg-cmp-row"
              style={s("background: #0d0c0b; padding: 26px 22px;")}
            >
              <div
                style={s(
                  `font-family: ${MONO}; font-size: 11px; color: #e8862e; margin-bottom: 12px;`,
                )}
              >
                {f.tag}
              </div>
              <h3
                style={s(
                  "font-size: 16.5px; color: #f5f1ea; margin: 0 0 8px; font-weight: 600;",
                )}
              >
                {f.title}
              </h3>
              <p
                style={s(
                  "font-size: 13.5px; line-height: 1.55; color: #8c847a; margin: 0;",
                )}
              >
                {f.desc}
              </p>
      ...
      <section style={s("border-top: 1px solid #211e1b; background: #100f0e;")}>
        ...
        >
          <div>
            ...
            <p
              style={s(
                "font-size: 15.5px; line-height: 1.6; color: #b8b0a6; margin: 0 0 16px;",
              )}
            >
              Auto-discover routes by crawling, or list them explicitly. Set
              per-route thresholds — strict on{" "}
              <span
                style={s(
                  `color: #e8862e; font-family: ${MONO}; font-size: 13px;`,
                )}
              >
                /checkout
              </span>
            ...
            <p
              style={s(
                "font-size: 15.5px; line-height: 1.6; color: #b8b0a6; margin: 0;",
              )}
            >
              <span
                style={s(
                  `color: #f5f1ea; font-family: ${MONO}; font-size: 13px;`,
                )}
              >
                frontguard init
              </span>{" "}
              auto-detects Next.js, Remix, SvelteKit, Nuxt or Astro and writes
              this for you.
            </p>
          </div>
          <div
          ...
          >
            <div
              style={s(
                "display: flex; align-items: center; gap: 8px; padding: 11px 16px; border-bottom: 1px solid #211e1b; background: #161412;",
              )}
            >
              <span
                style={s(
                  "width: 10px; height: 10px; border-radius: 50%; background: #322d28;",
                )}
              />
              <span
                style={s(
              ...
              <span
                style={s(
                  `margin-left: 10px; font-family: ${MONO}; font-size: 12px; color: #564f48;`,
                )}
              >
            ...
            <pre
              style={s(
                `margin: 0; padding: 20px 22px; font-family: ${MONO}; font-size: 12.5px; line-height: 1.7; color: #b8b0a6; overflow-x: auto;`,
              )}
              dangerouslySetInnerHTML={{ __html: CONFIG_HTML }}
            />
          </div>
        </div>
      </section>
      ...
      >
          ...
          >
            <thead>
              <tr style={s("background: #161412;")}>
                <th
                  style={s(
                    `text-align: left; padding: 16px 18px; font-family: ${MONO}; font-size: 11px; color: #7c746b; font-weight: 500; letter-spacing: 0.04em;`,
                  )}
                >
                  CAPABILITY
                </th>
                {[
                  ...
                  <th
                    key={h}
                    style={s(
                      `padding: 16px 14px; font-family: ${MONO}; font-size: 12px; color: ${i === 0 ? "#e8862e" : "#8c847a"}; font-weight: ${i === 0 ? 700 : 500};`,
                    )}
                  >
                    {h}
                  </th>
            ...
            <tbody>
              {comparison.map((row) => (
                <tr
                  ...
                  style={s("border-top: 1px solid #211e1b;")}
                >
                  <td style={s("padding: 14px 18px; color: #d8d0c5;")}>
                    {row.cap}
                  </td>
                  <td
                    style={s(
                      `text-align: center; padding: 14px; color: #4fb477; font-family: ${MONO}; font-weight: 700;`,
                    )}
                  >
                    {row.fg}
                  </td>
                  <td
                    style={s(
                      `text-align: center; padding: 14px; color: #6b645c; font-family: ${MONO};`,
                    )}
                  >
                    {row.percy}
                  </td>
        ...
        <Link
          to={"/comparisons" as "/"}
          style={s(
            `display: inline-flex; margin-top: 24px; font-family: ${MONO}; font-size: 13px; color: #e8862e; text-decoration: none;`,
          )}
        >
      ...
      {/* ============ PLUGINS ============ */}
      <section
        style={s("max-width: 1200px; margin: 0 auto; padding: 20px 28px 84px;")}
      >
        <div
          style={s(
            "border: 1px solid #2a2622; background: #131210; padding: 36px 32px;",
          )}
        >
          <div
            style={s(
              "display: flex; align-items: baseline; justify-content: space-between; flex-wrap: wrap; gap: 16px; margin-bottom: 28px;",
            )}
          >
            <h3
              style={s(
          ...
          >
            {plugins.map((p) => (
              <div
                key={p.name}
                style={s("border-top: 2px solid #e8862e; padding-top: 14px;")}
              >
                <div
                  style={s(
                    `font-family: ${MONO}; font-size: 13px; color: #f5f1ea; margin-bottom: 6px; font-weight: 500;`,
                  )}
                >
                  {p.name}
                </div>
      ...
      >
        ...
        >
          Skeptical engineers built this for skeptical engineers. No silver
        ...
        >
          {honest.map((h) => (
            ...
            >
              <div
                style={s(
                  `font-family: ${MONO}; font-size: 12px; color: ${h.color}; margin-bottom: 16px;`,
                )}
              >
                {h.label}
              </div>
      ...
      <section style={s("border-top: 1px solid #211e1b; background: #100f0e;")}>
        <div
          style={s(
            "max-width: 1200px; margin: 0 auto; padding: 90px 28px; text-align: center;",
          )}
        >
          ...
          <h2
            style={s(
              "font-size: 44px; letter-spacing: -0.035em; font-weight: 700; color: #f5f1ea; margin: 0 0 16px;",
            )}
          >
          ...
          <div
            style={s(
              "display: inline-flex; align-items: stretch; border: 1px solid #322d28; background: #161412; margin-bottom: 24px;",
            )}
          >
            <span
              style={s(
                `font-family: ${MONO}; font-size: 14px; color: #e6e0d6; padding: 14px 20px; white-space: nowrap;`,
              )}
            >
              <span style={s("color: #7c746b;")}>$ </span>npx -p @frontguard/cli
              frontguard init --ci
            ...
            <button
              onClick={() =>
                copyInit("npx -p @frontguard/cli frontguard init --ci")
              }
              className="fg-btn-ghost"
              style={s(
          ...
          <div style={s("display: flex; gap: 14px; justify-content: center;")}>
            <Link
              ...
              className="fg-btn-primary"
              style={s(
                `background: #e8862e; color: #0d0c0b; font-family: ${MONO}; font-weight: 700; font-size: 14px; padding: 14px 28px; text-decoration: none;`,
              )}
            >
              Read the docs →
            </Link>
            <a
              ...
              className="fg-btn-ghost"
              style={s(
                `border: 1px solid #322d28; color: #f5f1ea; font-family: ${MONO}; font-weight: 500; font-size: 14px; padding: 14px 28px; text-decoration: none;`,
              )}
            >
              ★ Star on GitHub
            </a>
